...
{
    DFS_CHANNEL_AVAILABLE = 0,
    DFS_CHANNEL_CAC_ONGOING,
    DFS_CHANNEL_NON_OCCUPANCY_PERIOD,
    DFS_CHANNEL_NOT_CLEARED
}
...
_COSA_DML_WIFI_RadiusSetting
{
    ...
    unsigned int                    iPMKLifetime;
    unsigned int                    iPMKCacheInterval;
    unsigned int                    iReAuthInterval;
...
void enable_reset_both_radio_flag(void);
