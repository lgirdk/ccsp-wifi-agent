    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "InterimInterval", TRUE))
    {
        /* collect value */
    ...
    if( AnscEqualString(ParamName, "SecondaryServerPort", TRUE))
    {
        /* collect value */
    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "Secret", TRUE))
    {
        /* Acct Secret should always return empty string when read */
        AnscCopyString(pValue, "");
    }

    if( AnscEqualString(ParamName, "SecondarySecret", TRUE))
    {
        /* Acct Secret should always return empty string when read */
        AnscCopyString(pValue, "");
    }

    if( AnscEqualString(ParamName, "ServerIPAddr", TRUE))
    {
        /* Acct Secret should always return empty string when read */
        AnscCopyString(pValue, pWifiApAcct->Cfg.AcctServerIPAddr);
    }

    if( AnscEqualString(ParamName, "SecondaryServerIPAddr", TRUE))
    {
        /* Acct Secret should always return empty string when read */
