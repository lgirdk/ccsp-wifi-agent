    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "ChannelInPool", TRUE))
    {
        *pBool = pChannelStats->ChannelInPool;
        return TRUE;
    }
    if( AnscEqualString(ParamName, "ChannelRadarNoise", TRUE))
    {
    ...
    )
{
    ...
    /* check the parameter name and return the corresponding value */
    if( AnscEqualString(ParamName, "ChannelNumber", TRUE) )
    {
        *pInt = pChannelStats->ChannelNumber;
        return TRUE;
    }
    if( AnscEqualString(ParamName, "ChannelNoise", TRUE) )
    {
        *pInt = pChannelStats->ChannelNoise;
        return TRUE;
    }
    if( AnscEqualString(ParamName, "ChannelMax80211Rssi", TRUE) )
    {
        *pInt = pChannelStats->ChannelMax80211Rssi;
        return TRUE;
    }
    if( AnscEqualString(ParamName, "ChannelNon80211Noise", TRUE) )
    {
        *pInt = pChannelStats->ChannelNon80211Noise;
        return TRUE;
    }
    if( AnscEqualString(ParamName, "ChannelUtilization", TRUE) )
    {
    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "UtilizationTotal", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "UtilizationBusy", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "UtilizationTxBusy", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "UtilizationRxBusy", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "UtilizationBusySelf", TRUE))
    {
    ...
    if( AnscEqualString(ParamName, "UtilizationBusyExt", TRUE))
    {
