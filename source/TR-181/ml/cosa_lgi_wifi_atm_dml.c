    ...
    )
{
	...
	if (AnscEqualString(ParamName, "TrafficDirection", TRUE))
	{
    ...
    )
{
	...
	if (AnscEqualString(ParamName, "BKWeight", TRUE))
	{
    ...
    )
{
	...
	/* check the parameter name and return the corresponding value */
	if( AnscEqualString(ParamName, "DistributionType", TRUE))
	{
    ...
    )
{
	...
	if( AnscEqualString(ParamName, "STAWeight", TRUE))
	{
	...
	if( AnscEqualString(ParamName, "SSIDWeight", TRUE))
	{
		*puLong = pStatInfo->SSIDWeight;
		return TRUE;
	}
	if( AnscEqualString(ParamName, "CurrentPercentAirTime", TRUE))
	{
		*puLong = pStatInfo->MeasuredAirTime;
		return TRUE;
	}
	if( AnscEqualString(ParamName, "CumulativeAirTime", TRUE))
	{
